...
Lastly, note that the detection distances are high between 100--200 m, and recall that the stations were placed 150 m apart. Since the stations on a transect were (generally) visited in sequence, this means it is possible a bird could have been observed from more than one station. 
...
However, it is clear the literature is divided and unclear on whether or not our observation areas should overlap.
